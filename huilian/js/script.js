...
//          $(this).siblings('.act_list').find('li').not('li:first').hide();
  ...
  //                request.setRequestHeader("sessionToken", $('#hiddensessionToken').val());
  //            },
          dataType: 'json',
          success: callback
      });
